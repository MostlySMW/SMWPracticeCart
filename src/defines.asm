...
!fast_mode_save_level_count               = !fast_mode_save_current_header+0
!fast_mode_save_version                   = !fast_mode_save_current_header+1
!fast_mode_save_show_timer                = !fast_mode_save_current_header+2
!fast_mode_save_show_requirements         = !fast_mode_save_current_header+3
!fast_mode_current_lvl_decomp    = $06C0
!fast_mode_save_current_level             = !fast_mode_current_lvl_decomp+0
!fast_mode_save_current_item_box_start    = !fast_mode_current_lvl_decomp+1
!fast_mode_save_current_item_box_end      = !fast_mode_current_lvl_decomp+2
!fast_mode_save_current_powerup_start     = !fast_mode_current_lvl_decomp+3
!fast_mode_save_current_powerup_end       = !fast_mode_current_lvl_decomp+4
!fast_mode_save_current_yoshi_start       = !fast_mode_current_lvl_decomp+5
!fast_mode_save_current_yoshi_end         = !fast_mode_current_lvl_decomp+6
!fast_mode_save_current_red_switch        = !fast_mode_current_lvl_decomp+7
!fast_mode_save_current_blue_switch       = !fast_mode_current_lvl_decomp+8
!fast_mode_save_current_yellow_switch     = !fast_mode_current_lvl_decomp+9
!fast_mode_save_current_green_switch      = !fast_mode_current_lvl_decomp+10
!fast_mode_save_current_special_clear     = !fast_mode_current_lvl_decomp+11
!fast_mode_save_current_midway_enable     = !fast_mode_current_lvl_decomp+12
!fast_mode_save_current_exit_type         = !fast_mode_current_lvl_decomp+13
!fast_mode_save_current_item_box_required = !fast_mode_current_lvl_decomp+14
!fast_mode_save_current_yoshi_required    = !fast_mode_current_lvl_decomp+15
!fast_mode_save_current_powerup_required  = !fast_mode_current_lvl_decomp+16
!fast_mode_save_current_exit_required     = !fast_mode_current_lvl_decomp+17
!most_recent_exit              = $06D2
